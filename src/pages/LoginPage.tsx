      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary-600 via-primary-700 to-accent-700 relative overflow-hidden">
        ...
        <div className="relative flex flex-col justify-between p-12 text-white">
          ...
          <div className="space-y-3 text-sm text-primary-100">
            <p className="flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-accent-300" /> Demo admin: admin@smartexam.com / Sm@rtEx@m#2026</p>
            <p className="flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-accent-300" /> Demo student: student1@smartexam.com / Stud#nt2026!x</p>
          </div>
        </div>
      </div>
